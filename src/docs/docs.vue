<template lang="html">
  <div class="container col-4 col-xl-6 col-md-8 col-sm-10 col-xs-12">
    ...
    <p class="text-center">
      <a class="btn" href="https://github.com/vuejs-tips/v-money"
        >https://github.com/vuejs-tips/v-money</a
      >
    </p>
    ...
    <label
      >Directive on Custom Component (TextField from
      <a href="https://vuetifyjs.com/components/text-fields">vuetify</a>)</label
    >
    <div class="columns">
      <div class="column col-6 col-sm-12">
